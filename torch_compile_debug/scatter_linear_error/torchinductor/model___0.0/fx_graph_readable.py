class <lambda>(torch.nn.Module):
    def forward(self):
        ...
        view_1: "f32[1, 32]" = torch.ops.aten.view.default(l__self___linear_weight, [-1, 32]);  l__self___linear_weight = None
        ...
        view_4: "f32[32, 1]" = torch.ops.aten.view.default(scatter_add, [-1, 1]);  scatter_add = None
        view_5: "f32[32, 1, 1]" = torch.ops.aten.view.default(view_4, [32, 1, 1]);  view_4 = None
        ...
        view_6: "f32[32, 1]" = torch.ops.aten.view.default(permute, [32, 1]);  permute = None
        ...
        view_8: "f32[32, 1, 32]" = torch.ops.aten.view.default(mm, [32, 1, 32]);  mm = None
        ...
        view_9: "f32[32, 32]" = torch.ops.aten.view.default(permute_2, [32, 32]);  permute_2 = None
