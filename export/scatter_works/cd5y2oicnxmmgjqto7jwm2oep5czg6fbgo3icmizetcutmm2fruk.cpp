...
AOTInductorModel::AOTInductorModel(std::shared_ptr<ConstantMap> constants_map,
    ...
    : AOTInductorModelBase(2, 1, 0, device_str, cubin_dir) {
...
void AOTInductorModel::run_impl(
    ...
    if (kernels.triton_poi_fused_scatter_add_zeros_0 == nullptr) {
        kernels.triton_poi_fused_scatter_add_zeros_0 = loadKernel("/home/mkotak/atomic_architects/projects/export_debug/export/scatter_works/ctuhytsabbtyxjlc26sbbue4l3tb5lshxiyubzcaonz7aawvkf65.cubin", "triton_", 0, this->cubin_dir_);
    }
    ...
    if (kernels.triton_poi_fused_scatter_add_zeros_1 == nullptr) {
        kernels.triton_poi_fused_scatter_add_zeros_1 = loadKernel("/home/mkotak/atomic_architects/projects/export_debug/export/scatter_works/czqgtp3buhz3yetr7av4iu63wegv4yqf2st5p2vfqb7aw4xl2eeh.cubin", "triton_", 512, this->cubin_dir_);
    }
    CUdeviceptr var_2 = reinterpret_cast<CUdeviceptr>(arg1_1.data_ptr());
    CUdeviceptr var_3 = reinterpret_cast<CUdeviceptr>(arg0_1.data_ptr());
    ...
    arg0_1.reset();
    arg1_1.reset();
    output_handles[0] = reinterpret_cast<AtenTensorHandle>(new at::Tensor(buf0));
} // AOTInductorModel::run_impl
} // namespace aot_inductor
} // namespace torch

// Compile cmd
// g++ /home/mkotak/atomic_architects/projects/export_debug/export/scatter_works/cd5y2oicnxmmgjqto7jwm2oep5czg6fbgo3icmizetcutmm2fruk.cpp -fPIC -Wall -std=c++17 -Wno-unused-variable -Wno-unknown-pragmas -D_GLIBCXX_USE_CXX11_ABI=0 -I/home/mkotak/.local/lib/python3.10/site-packages/torch/include -I/home/mkotak/.local/lib/python3.10/site-packages/torch/include/torch/csrc/api/include -I/home/mkotak/.local/lib/python3.10/site-packages/torch/include/TH -I/home/mkotak/.local/lib/python3.10/site-packages/torch/include/THC -I/usr/local/cuda-12.5/include -I/usr/include/python3.10 -mavx2 -mfma -D CPU_CAPABILITY_AVX2 -D USE_CUDA -O3 -DNDEBUG -ffast-math -fno-finite-math-only -fno-unsafe-math-optimizations -ffp-contract=off -march=native -fopenmp -D TORCH_INDUCTOR_CPP_WRAPPER -D C10_USING_CUSTOM_GENERATED_MACROS -c -o /home/mkotak/atomic_architects/projects/export_debug/export/scatter_works/cd5y2oicnxmmgjqto7jwm2oep5czg6fbgo3icmizetcutmm2fruk.o
// Link cmd
// g++ /home/mkotak/atomic_architects/projects/export_debug/export/scatter_works/cd5y2oicnxmmgjqto7jwm2oep5czg6fbgo3icmizetcutmm2fruk.o /home/mkotak/atomic_architects/projects/export_debug/export/scatter_works/c4oymiquy7qobjgx36tejs35zeqt24qpemsnzgtfeswmrw6csxbk.o -shared -fPIC -Wall -std=c++17 -Wno-unused-variable -Wno-unknown-pragmas -D_GLIBCXX_USE_CXX11_ABI=0 -I/home/mkotak/.local/lib/python3.10/site-packages/torch/include -I/home/mkotak/.local/lib/python3.10/site-packages/torch/include/torch/csrc/api/include -I/home/mkotak/.local/lib/python3.10/site-packages/torch/include/TH -I/home/mkotak/.local/lib/python3.10/site-packages/torch/include/THC -I/usr/local/cuda-12.5/include -I/usr/include/python3.10 -L/home/mkotak/.local/lib/python3.10/site-packages/torch/lib -L/usr/local/cuda-12.5/lib64 -L/usr/lib/x86_64-linux-gnu -L/home/mkotak/.local/lib/python3.10/site-packages/torch/lib -ltorch -ltorch_cpu -lgomp -lc10_cuda -lcuda -ltorch_cuda -lc10 -mavx2 -mfma -D CPU_CAPABILITY_AVX2 -D USE_CUDA -O3 -DNDEBUG -ffast-math -fno-finite-math-only -fno-unsafe-math-optimizations -ffp-contract=off -march=native -fopenmp -D TORCH_INDUCTOR_CPP_WRAPPER -D C10_USING_CUSTOM_GENERATED_MACROS -o /home/mkotak/atomic_architects/projects/export_debug/export/scatter_works/model.so
